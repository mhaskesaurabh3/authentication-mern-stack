...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='bg-nav-color w-screen fixed top-0 z-50 border-gray-200 dark:bg-gray-900 h-16'>
        <div className='max-w-screen-xl flex justify-between flex-wrap items-start w-full  mx-auto p-4'>
          ...
          <div className='relative search-input '>
            <input
              type='search'
              className='bg-purple-white shadow rounded border-0 p-3 w-96 h-9'
